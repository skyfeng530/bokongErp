...
insert  into `resources`(`id`,`name`,`parentId`,`resKey`,`type`,`resUrl`,`level`,`description`) values(84,'产品查询',7,'statistics_manager','1','/background/project/product/query.html',4,'产品查询');
insert  into `resources`(`id`,`name`,`parentId`,`resKey`,`type`,`resUrl`,`level`,`description`) values(85,'任务查询',7,'statistics_manager','1','/background/project/task/query.html',4,'任务查询');
#增加角色控制，可以和部门对应
