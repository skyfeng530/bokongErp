function mainView()
{
	...
	var gridStore = new Ext.data.Store({  
        proxy: new Ext.data.HttpProxy({ url: "../../background/storageOutInput/queryListData.html"}),  
...
//         "-",
	...
	var form = new Ext.form.FormPanel({
		...
		{columnWidth:.25,layout:'form',items:[{
			xtype:'numberfield',id:'realReceiveNumId',msgTarget:'qtip',fieldLabel:'实领数量'
		}]}
		],
		buttons:[{
			text:"确认",
	...
	function setDisabled(bool)
	{
		 ...
		 Ext.getCmp('realReceiveNumId').setDisabled(bool);
	...
	var submit = new Ext.Button({
		...
		text: "提交",
		handler:function(){
			  window.location.href="../../background/workflow/storageout_stock.html"
		}
	});
