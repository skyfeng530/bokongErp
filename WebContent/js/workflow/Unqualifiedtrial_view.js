	...
	var partTransfer = {
		...
		items : [ {
			...
			items : [ {
				...
				blankText : '不能为空',
				readOnly : true,
				value : "SLD" + taskName + new Date().getFullYear() +'1' + "(G)"
			}, {
				id : 'Trialorg_id',
				fieldLabel : '审理组织',
				anchor : '85%',
				...
				allowBlank : false,
				blankText : '不能为空',
				store : workflow.states.trialOrgStore,
				emptyText : '请选择...',
				mode : 'local',
				valueField : 'value',
				displayField : 'text',
			...
			items : [ {
				...
				allowBlank : false,
				blankText : '不能为空',
				store : workflow.states.trialResultsStore,
				emptyText : '请选择...',
				mode : 'local',
				valueField : 'value',
				displayField : 'text',
		...
		buttons : [
				{
					...
					handler : function() {
						...
						var TrialResults = Ext.getCmp("trialresults_id")
								.getValue();
