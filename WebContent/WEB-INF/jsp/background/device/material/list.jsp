...
<body>
<form id="fenye" name="fenye" action="${pageContext.servletContext.contextPath }/background/device/material/query.html" method="post">
<table width="100%">
  <tr>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：库房管理-器件</td>
              </tr>
            </table></td>
              ...
              <tr>
                ...
                <td width="60"><table width="90%">
                  <tr>
                    ...
                    <td class="STYLE1"><div align="center"><a href="${pageContext.servletContext.contextPath }/background/device/material/addUI.html">新增</a></div></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <tr>
            ...
            <a href="${pageContext.servletContext.contextPath }/background/device/material/getById.html?id=${key.id}&&type=1">
                                     编辑
            </a>
            &nbsp; &nbsp;
           </sec:authorize>
