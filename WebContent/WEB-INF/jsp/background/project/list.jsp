...
<body>
<form id="fenye" name="fenye" action="${pageContext.servletContext.contextPath }/background/project/query.html" method="post">
<table width="100%">
  <tr>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：项目管理-项目查询</td>
              </tr>
            </table></td>
              ...
              <tr>
                ...
                <td width="60"><table width="90%">
                  <tr>
                    ...
                    <td class="STYLE1"><div align="center"><a href="${pageContext.servletContext.contextPath }/background/project/addUI.html">新增</a></div></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="30%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">项目名称</span></td>
            <td width="30%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">项目描述</span></td>
            <td  height="40%" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">基本操作</td>
          </tr>
          
          <c:forEach var="key" items="${pageView.records}">
          <tr>
            <td height="20" >
              <input type="checkbox" name="check" value="${key.pid}" />
            </td>
            
            <td height="20" ><span class="STYLE1"><a href="${pageContext.servletContext.contextPath }/background/project/getById.html?id=${key.pid}&&type=0">${key.projectName}</a></span></td>
            <td height="20" ><span class="STYLE1">${key.projectDescribe}</span></td>
            ...
            <a href="${pageContext.servletContext.contextPath }/background/project/getById.html?id=${key.pid}&&type=1">
                                     编辑
            </a>
            &nbsp; &nbsp;
           </sec:authorize>
