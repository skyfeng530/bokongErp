...
<body>
<form id="fenye" name="fenye" action="${pageContext.servletContext.contextPath }/background/project/product/product/query.html" method="post">
<table width="100%">
  <tr>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：项目管理-产品查询</td>
              </tr>
            </table></td>
              ...
              <tr>
                ...
                <td width="60"><table width="90%">
                  <tr>
                    ...
                    <td class="STYLE1"><div align="center"><a href="${pageContext.servletContext.contextPath }/background/project/product/product/addUI.html">新增</a></div></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="13%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">产品代号</span></td>
            <td width="13%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">产品名称</span></td>
            <td width="13%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">产品状态</span></td>
          ...
          <tr>
            ...
            <a href="${pageContext.servletContext.contextPath }/background/project/product/getById.html?id=${key.ppid}&&type=1">
                                     编辑
            </a>
            &nbsp; &nbsp;
           </sec:authorize>
