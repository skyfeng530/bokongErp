          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：项目管理-任务查询</td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <tr>
            ...
            <a href="${pageContext.servletContext.contextPath }/background/project/task/getById.html?id=${key.taskId}&&type=1">
                                     编辑
            </a>
            &nbsp; &nbsp;
           </sec:authorize>
